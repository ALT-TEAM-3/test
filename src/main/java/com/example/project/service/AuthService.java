...
public class AuthService {
    ...
    @Transactional public UserResponse signup(SignupRequest request) {
    ...
    public TokenResponse login(LoginRequest request) {
        ...
        if (!passwordEncoder.matches(request.password(), user.getPasswordHash())) throw new CustomException(ErrorCode.UNAUTHORIZED);
